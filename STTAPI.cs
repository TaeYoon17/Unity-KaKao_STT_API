...
namespace KaKaoVoiceAPI
{
    ...
    public class kakaoSTT
    {
        ...
        private void init(string rest_api_key, AudioClip clip)
        {
        ...
        public kakaoSTT(string rest_api_key, AudioSource source)
        {
            init(rest_api_key, source.clip);
        }
        public kakaoSTT(string rest_api_key, AudioClip clip)
        {
        ...
        static public sttJson getJSON(string text)
        {
            var textList = text.Split(new string[] { "\r\n" }, StringSplitOptions.None).
                Where(v => v.Contains("finalResult"));
